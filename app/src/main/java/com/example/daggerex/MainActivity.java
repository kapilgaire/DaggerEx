...
import com.example.daggerex.di.component.ActivityComponent;
import com.example.daggerex.di.component.DaggerActivityComponent;
    ...
    public ActivityComponent getActivityComponent() {
        if (activityComponent == null) {
            activityComponent = DaggerActivityComponent.builder()
                    ...
                    .applicationComponent(DaggerEx.get(this).getComponent())
                    .build();
        }
